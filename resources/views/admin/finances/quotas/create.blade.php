...
@section('breadcrumb')
    ...
    <li class="breadcrumb-current-item">Nova</li>
@endsection
    ...
    <div class="row">
        <div class="panel">
            <div class="panel-heading">
                ...
                <span class="panel-title">Nova Cota</span>
            </div>
            <div class="panel-body">
                <div class="row">
                    <form action="{{ route('admin.finance.quotas.store') }}" method="POST">
                        {!! csrf_field() !!}

                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                                <label for="text">Texto</label>
                                <input type="text" name="text" id="text" value="{{ old('text') }}" class="form-control" placeholder="Descrição">
                            @if ($errors->has('text'))
